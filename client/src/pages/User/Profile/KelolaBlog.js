                        ...
                        blog.map((item) => (
                          <tr key={item.id}>
                            ...
                            <td>
                              ...
                              <i class="bi bi-pencil-square" style={{ color: '#A08336', paddingRight: '10px', marginLeft: '5px', cursor: 'pointer' }}></i>
                              <i class="bi bi-eye-fill" onClick={() => loadBlogDetail(item.slug)} style={{ color: '#A08336', marginRight: '5px', cursor: 'pointer' }}></i>
                            </td>
                          </tr>
                        ))}
                    </tbody>
