        ...
        <MDBCol col="12">
          <MDBCard className="bg-white my-5 mx-auto" style={{ borderRadius: '10px', maxWidth: '644px' }}>
            <MDBCardBody className="p-5 w-100 d-flex flex-column ">
              ...
              <MDBInput wrapperClass="mb-4 w-100" id="formControlLg" type="email" size="lg" style={{ fontSize: '16px' }} placeholder="your full name" className="focus-ring focus-ring-light " autoComplete="new-password" />
              <p className="text-black-100" style={{ fontSize: '16px' }}>
                Email
              </p>
